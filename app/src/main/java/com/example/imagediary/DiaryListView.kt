...
class DiaryListView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Note that you don't need to pass data back and forth (DiaryListView -> DetailActivity and DetailActivity -> DiaryListView)
